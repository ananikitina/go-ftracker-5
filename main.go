...
func (w Walking) Calories() float64 {
	...
	heightSm := w.Height / CmInM
	result := ((CaloriesWeightMultiplier*w.Weight + (math.Pow(speedMinSec, 2)/heightSm)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
	return result
}
